...
export default function Sidebar({ toggleSidebar, showSidebar }) {
  ...
  return (
    <>
      <aside className="nav z-30 w-64 h-screen fixed lg:sticky top-0 border-r shrink-0">
        <div className="sidebar h-full px-3 scroll-smooth overflow-y-auto bg-gray-50 dark:bg-gray-800">
